...
def read_dict(voc=None):
    """
        Зачитываем словарь вордтувеков слов которые есть в текстах
        :param voc:
        :return:
    """
...
if __name__ == "__main__":
    ...
    clusterers = [
        ...
        (MiniBatchKMeans(n_clusters=5, verbose=1, init_size=500, random_state=124), "MiniBatchKMeans50_init500"),
    ]
